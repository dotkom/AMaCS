      ...
      err => {
        ...
        const errorMessage =
          err instanceof Array
            ? err
            : "Pass på at du har fylt ut alle feltene og valgt komiteer å søke.";
        this.setState({
          disableSubmit: false,
    ...
    return (
      <div className={_s.component}>
        ...
        <div className={classNames(_s.alternative, _s.application)}>
          ...
          <p>
            Send inn din søknad hvor du forteller litt om deg selv, din
            motivasjon for vervet, og eventuelt tidligere erfaring fra lignende
            arbeid. Hold gjerne søknaden kort ettersom at vi arrangerer et
            intervju med hver søker så vi kan bli enda bedre kjent med deg.
          </p>
          <TextArea
