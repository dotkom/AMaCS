...
describe('TextArea', () => {
  ...
  it('calls onChange property when text changes', () => {
    ...
    const wrapper = shallow(<TextArea text="Test tex" onChange={onChangeMock} />);
  ...
  it('works without onChange ', () => {
    const changedText = 'Test text';
    const wrapper = shallow(<TextArea text="Test text" />);
  ...
  it('forwards extra props', () => {
    const wrapper = shallow(<TextArea placeholder="Placeholder text" />);
    expect(wrapper).toMatchSnapshot();
  });
});
